<template>
  <div class="blog-wrapper" :class="{'no-user': !user}"> 
        <div class="blog-content"> 
            <div> 
                <h2 v-if="post.welcomeScreen===true"> {{ post.blogTitle }}</h2>
                ...
                <router-link v-else class="link" :to="{name: 'ViewBlog', params: {blogid: this.post.blogID}}">View the Post <Arrow class="arrow"/></router-link>
            </div>
        </div>
...
.blog-wrapper {
    ...
    box-shadow: 0 4px 6px -1px black, 0 2px 4px -1px rgba(0,0,0,06);
